...
namespace OdeToFood_v5.Api
{
    ...
    public class RestaurantsController : ControllerBase
    {
        ...
        public RestaurantsController(MySQLDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> GetRestaurant([FromRoute] int id)
        {
            ...
            var restaurant = _context.Restaurants[0];
        ...
        public async Task<IActionResult> DeleteRestaurant([FromRoute] int id)
        {
            ...
            Restaurant restaurant = null; // await _context.Restaurants.FindAsync(id);
            if (restaurant == null)
            {
                return NotFound();
            }
